...
| 99.0% | 1.0% | **7.2 小时/月** | WebSocket：每月最多 7.2 小时连接失败 |
...
| WebSocket 成功率 | 99.5% | 99.5% | 0%（已与 SLA 对齐，ADR-V2-034） |

> **注意**：WebSocket 当前 SLO（99.0%）低于 SLA（99.5%），存在违约风险。
> 短期通过 Burn Rate 告警提前干预，长期目标将 WS SLO 提升至 99.5% 以上。
