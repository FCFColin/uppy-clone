...
执行状态跟踪文档。原则见 [CONTRIBUTING.md](../../CONTRIBUTING.md) 测试约定与「Code Simplification」小节。章程约束见 [ADR-000](../adr/000-project-charter.md)。
...
4. **保持平衡** — 不过度内联或合并无关逻辑
5. **范围可控** — 每 PR 一个主题；refactor 与 feature/fix 分 PR
