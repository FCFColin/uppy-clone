...
UNIT_MIN="${UNIT_MIN:-100}"
INT_MIN="${INT_MIN:-80}"
FRONTEND_LINES_MIN="${FRONTEND_LINES_MIN:-100}"
FRONTEND_BRANCHES_MIN="${FRONTEND_BRANCHES_MIN:-100}"
FRONTEND_FUNCTIONS_MIN="${FRONTEND_FUNCTIONS_MIN:-100}"
