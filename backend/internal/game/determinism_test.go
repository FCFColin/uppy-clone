...
func TestDeterministicTick_SameSeedSameHash(t *testing.T) {
	...
	hash1 := deterministicTickHash(t, tickCount, fixedTime, 42)
	hash2 := deterministicTickHash(t, tickCount, fixedTime, 42)
...
func TestDeterministicTick_DifferentSeedDifferentHash(t *testing.T) {
	...
	hash1 := deterministicTickHash(t, tickCount, fixedTime, 42)
	hash2 := deterministicTickHash(t, tickCount, fixedTime, 99)
...
func deterministicTickHash(t *testing.T, tickCount int, fixedTime time.Time, seed int64) string {
	t.Helper()
