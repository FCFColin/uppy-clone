...
// TestHub_CleanupLoop covers the cleanup behavior for various room states:
// empty waiting rooms, rooms with connections, expired disconnected players,
// zero-player rooms, and disconnected players still in grace period.
