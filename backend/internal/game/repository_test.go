...
func (m *mockRoomRepository) SaveLobbyState(ctx context.Context, ls *domain.LobbyState) error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.saveCount++
	if m.saveErr != nil {
...
func (m *mockRoomRepository) LoadLobbyState(ctx context.Context, code string) (*domain.LobbyState, error) {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.loadCount++
	if m.loadErr != nil {
...
func (m *mockRoomRepository) DeleteLobbyState(ctx context.Context, code string) error {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.deleteCount++
	if m.deleteErr != nil {
