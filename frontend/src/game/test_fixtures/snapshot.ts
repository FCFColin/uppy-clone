...
export function buildMinimalSnapshot(phaseCode: number, timestamp = 100): ArrayBuffer {
  ...
  let o = 1;
  dv.setUint32(o, timestamp, true);
  o += 4; // tickCount
  dv.setUint32(o, 42, true);
  o += 4; // score (default 42)
  dv.setUint8(o, phaseCode);
  o += 1; // phaseCode
